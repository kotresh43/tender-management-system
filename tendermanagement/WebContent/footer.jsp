...
<div class="navbar-inverse" style="color:white;padding:10px;margin-bottom:-20px;text-align: center;background-color:blue; border-radius: 0px">
                      <span style="font-size:1.2em;font-weight:bold;">Tender Management Portal</span>
</div><br/>
<div class="footer">    
  ...
  <div class="navbar-inverse" style="color:white;padding:05px;margin-bottom:-17px;text-align: center;background-color:green; border-radius: 0px">
                      <span style="float:left;padding-left: 6.5%">&copy; Copyright 2025</span><span style="padding-left:5%;">&nbsp; </span><span style="float:right;padding-right: 6%" class="hidden-xs">&nbsp;...THANKS FOR VISITING...</span>
</div><br/>
